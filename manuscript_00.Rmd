...
```{r figXGboost_umap, fig.width=8, fig.height=13, out.width=600, fig.cap=figXGboost_umap_cap, echo=FALSE, message = FALSE}
...
## Massive pseudbulk differential testing leverages high biological diversity
