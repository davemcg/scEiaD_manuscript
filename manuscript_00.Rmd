...
```{r figBenchmark, fig.width=8, fig.height=8, fig.cap=figBenchmark_cap, echo=FALSE, message = FALSE}
...
## ML cell type labels allow for high diversity in studies for each cell type
...
## Pseudobulk differential testing leverages high biological diversity
...
## Clustering
Louvain-jaccard as implemented by Seurat and leiden (implemented by PARC)
...
```{r supTab_CTmislabels, fig.cap=supTab_CTmislabels_cap, echo=FALSE, message = FALSE}
